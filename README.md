# Dead Tree Segmentation (NRG + RGB Hybrid Approach)
...
For a full list of available flags, run: python main.py --help.
...
Dark Red (Combined_Mask): Tree detected by my generated mask.
